...
> **📢 Version 1.0.1 Update** - Now supports Flutter 3.32.5 with latest build tools!  
> See [UPGRADE_GUIDE.md](UPGRADE_GUIDE.md) for migration instructions or [QUICK_REFERENCE.md](QUICK_REFERENCE.md) for quick setup.
...
| Bitmap Version | Flutter | Dart SDK | AGP | Gradle | Min SDK | FFI |
|----------------|---------|----------|-----|--------|---------|-----|
| 1.0.1 | ≥3.13.0 | ≥3.2.0 | 8.9.1 | 8.11.1 | 24 | 2.1.0 |
| 1.0.0 | ≥3.13.9 | ≥3.1.0 | 8.1.3 | 7.5 | 16 | 2.1.0 |

**✅ Tested with**: Flutter 3.32.5 + Dart 3.2.6 (ColorKahar setup)
